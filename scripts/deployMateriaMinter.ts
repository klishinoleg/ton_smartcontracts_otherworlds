...
import {MateriaMinter , JettonMinterContent, jettonContentToCell, jettonMinterConfigToCell } from '../wrappers/MateriaMinter';
...
export async function run(provider: NetworkProvider) {
    ...
    const wallet_code = await compile('MateriaWallet');

    const minter  = MateriaMinter.createFromConfig({admin,
                                                  content,
                                                  wallet_code,
                                                  },
